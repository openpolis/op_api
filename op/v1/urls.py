...
from op_api.op.handlers import LocationHandler, EducationLevelHandler, ProfessionHandler, StatisticsHandler, CityrepsHandler
...
cityreps_resource = Resource(handler=CityrepsHandler)
...
urlpatterns = patterns('',
    ...
    url(r'^cityreps/$', cityreps_resource),
)
